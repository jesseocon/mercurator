...
window.Mercury = {
  ...
  config: {
    ...
    injectedStyles: '' +
      ...
      '[data-mercury].focus { outline: none; -webkit-box-shadow: 0 0 10px #09F, 0 0 1px #045; box-shadow: 0 0 10px #09F, 0 0 1px #045 }' +
      'ydata-mercury]:after { content: "."; display: block; visibility: hidden; clear: both; height: 0; overflow: hidden; }' +
...
$(window).on('mercury:ready', function(){
    var link = $('#mercury_iframe').contents().find('#primary');
    Mercury.saveUrl = link.data('save-url');
    Mercury.Snippet.load({snippet_0: { name: 'spans'}});
